...
struct GlobStruct
{
	...
	LPDIRECT3DTEXTURE8			pCurrentBitmapTexture;
	LPDIRECT3DSURFACE8			pCurrentBitmapSurface;
	LPDIRECT3DSURFACE8			pHoldBackBufferPtr;
	LPDIRECT3DSURFACE8			pHoldDepthBufferPtr;
	DWORD						dwBSDSpare1;
	DWORD						dwBSDSpare2;
	DWORD						dwBSDSpare3;
	DWORD						dwBSDSpare4;
