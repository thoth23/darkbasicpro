...
void CEnhancedMatrixManager::Update ( float fX, float fY, float fZ )
{
	...
	// DX8->DX9
//	m_pD3D->SetTextureStageState ( 0, D3DTSS_ADDRESSU, 1 );
//	m_pD3D->SetTextureStageState ( 0, D3DTSS_ADDRESSV, 1 );
//	m_pD3D->SetTextureStageState ( 0, D3DTSS_MAGFILTER, 2 );	// mip mapping
//	m_pD3D->SetTextureStageState ( 0, D3DTSS_MINFILTER, 2 );	// mip mapping
//	m_pD3D->SetTextureStageState ( 0, D3DTSS_MIPFILTER, 2 );	// mip mapping
	m_pD3D->SetSamplerState ( 0, D3DSAMP_ADDRESSU, 1 );
	m_pD3D->SetSamplerState ( 0, D3DSAMP_ADDRESSV, 1 );
	m_pD3D->SetSamplerState ( 0, D3DSAMP_MAGFILTER, 2 );	// mip mapping
	m_pD3D->SetSamplerState ( 0, D3DSAMP_MINFILTER, 2 );	// mip mapping
	m_pD3D->SetSamplerState ( 0, D3DSAMP_MIPFILTER, 2 );	// mip mapping
