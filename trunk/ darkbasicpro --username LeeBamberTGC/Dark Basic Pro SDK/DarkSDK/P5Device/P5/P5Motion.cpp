...
float ffXPos = 0, ffYPos = 0, ffZPos = 0;
...
float fFilterXAdd, fFilterYAdd, fFilterZAdd = 0.0f;
...
void P5Motion_FilterXYZ()
{
	...
	if (myP5Device != NULL)
	{
		...
		// apply adjustment from resets
		fFilterX -= fFilterXAdd;
		fFilterY -= fFilterYAdd;
		fFilterZ -= fFilterZAdd;
	}
}
...
void P5Motion_Reset()
{
	fFilterXAdd+=fFilterX;
	fFilterYAdd+=fFilterY;
	fFilterZAdd+=fFilterZ;
	fFilterX=0.0f;
	fFilterY=0.0f;
	fFilterZ=0.0f;
}
